...
const QWERTY_LAYOUT: LayoutSpec = [
    Escape, Grave, Key1, Key2, Key3, Key4, Key5, Key6, Key7, Key8, Key9, Key0, Minus, Equals, Back,
    Tab, Q, W, E, R, T, Y, U, I, O, P, LBracket, RBracket, Backslash, A, S, D, F, G, H, J, K, L,
    Semicolon, Apostrophe, Return, LShift, Z, X, C, V, B, N, M, Comma, Period, Slash, RShift,
    LControl, LAlt, LWin, Space, RWin, RAlt, Left, Up, Down, Right,
];
const DVORAK_LAYOUT: LayoutSpec = [
    Escape, Grave, Key1, Key2, Key3, Key4, Key5, Key6, Key7, Key8, Key9, Key0, LBracket, RBracket,
    Back, Tab, Apostrophe, Comma, Period, P, Y, F, G, C, R, L, Slash, Equals, Backslash, A, O, E,
    U, I, D, H, T, N, S, Minus, Return, LShift, Semicolon, Q, J, K, X, B, M, W, V, Z, RShift,
    LControl, LAlt, LWin, Space, RWin, RAlt, Left, Up, Down, Right,
];
